 ...
 *
 * @since IdeaBoard (r4724)
 * @link Codex Docs http://codex.ideaboard.org/import-forums/vbulletin
 */
class vBulletin extends IdeaBoard_Converter_Base {
	...
	private function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin_user_skype'
		);
	}
