 ...
 *
 * @since IdeaBoard (r5151)
 * @link Codex Docs http://codex.ideaboard.org/import-forums/vbulletin
 */
class vBulletin3 extends IdeaBoard_Converter_Base {
	...
	private function setup_globals() {
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'icq',
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin3_user_icq'
		);
		...
		$this->field_map[] = array(
			...
			'from_fieldname' => 'msn',
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin3_user_msn'
		);
		...
		$this->field_map[] = array(
			...
			'to_type'        => 'user',
			'to_fieldname'   => '_ideaboard_vbulletin3_user_skype'
		);
	}
