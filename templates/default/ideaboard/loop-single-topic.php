...
<ul id="ideaboard-topic-<?php ideaboard_topic_id(); ?>" <?php ideaboard_topic_class(); ?>>

	<li class="ideaboard-topic-title">
		...
		<a class="ideaboard-topic-permalink" href="<?php ideaboard_topic_permalink(); ?>"><?php ideaboard_topic_title(); ?></a>
		...
		<p class="ideaboard-topic-meta">
			...
			<span class="ideaboard-topic-started-by"><?php printf( __( 'Started by: %1$s', 'ideaboard' ), ideaboard_get_topic_author_link( array( 'size' => '14' ) ) ); ?></span>
			...
			<?php if ( !ideaboard_is_single_forum() || ( ideaboard_get_topic_forum_id() !== ideaboard_get_forum_id() ) ) : ?>
				...
				<span class="ideaboard-topic-started-in"><?php printf( __( 'in: <a href="%1$s">%2$s</a>', 'ideaboard' ), ideaboard_get_forum_permalink( ideaboard_get_topic_forum_id() ), ideaboard_get_forum_title( ideaboard_get_topic_forum_id() ) ); ?></span>
	...
	<li class="ideaboard-topic-voice-count"><?php ideaboard_topic_voice_count(); ?></li>

	<li class="ideaboard-topic-reply-count"><?php ideaboard_show_lead_topic() ? ideaboard_topic_reply_count() : ideaboard_topic_post_count(); ?></li>

	<li class="ideaboard-topic-freshness">
		...
		<p class="ideaboard-topic-meta">
			...
			<span class="ideaboard-topic-freshness-author"><?php ideaboard_author_link( array( 'post_id' => ideaboard_get_topic_last_active_id(), 'size' => 14 ) ); ?></span>
...
</ul><!-- #ideaboard-topic-<?php ideaboard_topic_id(); ?> -->
