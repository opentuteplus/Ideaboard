...
/**
 * Template Name: IdeaBoard - User Lost Password
 *
 * @package IdeaBoard
 * @subpackage Theme
 */
...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="ideaboard-lost-pass" class="ideaboard-lost-pass">
			...
			<div class="entry-content">
				...
				<div id="ideaboard-forums">
					...
					<?php ideaboard_get_template_part( 'form', 'user-lost-pass' ); ?>

				</div>
			</div>
		</div><!-- #ideaboard-lost-pass -->
